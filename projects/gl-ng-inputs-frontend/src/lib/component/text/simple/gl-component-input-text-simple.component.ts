...
import { ISimpleTextResult, TInputTextMask } from './gl-component-input-text-simple.interface';
...
export class GlComponentInputTextSimpleComponent implements AfterViewInit, OnDestroy {
