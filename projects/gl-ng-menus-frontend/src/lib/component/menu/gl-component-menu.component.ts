...
@Component({
    ...
    standalone: true,
  imports: [GlComponentMenuBackgroundComponent, GlComponentMenuItemComponent, RouterLink, NgOptimizedImage]
})
export class GlComponentMenuComponent implements OnInit {
  ...
  @Input() className: string | 'dark' | 'translucid' | '' = '';
  @Input() settingsUrl: string;
  @Input() settingsTarget: TUrlTargets = '_blank';
