...
let GlSharedComponentButtonAttachmentService = class GlSharedComponentButtonAttachmentService {
    constructor(_alert) {
        this._alert = _alert;
    }
...
GlSharedComponentButtonAttachmentService.ctorParameters = () => [
    { type: GlSharedComponentModalAlertService }
];
GlSharedComponentButtonAttachmentService.ɵprov = ɵɵdefineInjectable({ factory: function GlSharedComponentButtonAttachmentService_Factory() { return new GlSharedComponentButtonAttachmentService(ɵɵinject(GlSharedComponentModalAlertService)); }, token: GlSharedComponentButtonAttachmentService, providedIn: "root" });

let GlSharedComponentButtonAttachmentComponent = class GlSharedComponentButtonAttachmentComponent {
    constructor(service) {
        this.service = service;
        /**
...
GlSharedComponentButtonAttachmentComponent.ctorParameters = () => [
