            ...
            setTimeout(function () {
                ...
                if (_this.mask != null) {
                    if (_this.mask.includes('currency')) {
                        ...
                        _this.placeholder = glWFrontend.InputMask[_this.mask](input, _this.allowMinus, _this.decimalSeparator, _this.rightAlign, _this.step);
                    }
                    else if (_this.mask === 'integer') {
                        _this.placeholder = glWFrontend.InputMask.integer(input, _this.allowMinus, _this.rightAlign, _this.step);
                    }
                }
            }, 0);
        };
